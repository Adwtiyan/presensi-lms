                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="course_id"
                                    id="example-text-input" value="{{ $schedule->courses->course_title }}" readonly>
                            </div>
                            <br><br>
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="time" name="schedule_start"
                                    placeholder="Schedule Start" id="example-text-input" value="{{ $schedule->schedule_start }}">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="time" name="schedule_finish"
                                    placeholder="Schedule Finish" id="example-text-input" value="{{ $schedule->schedule_finish }}">
