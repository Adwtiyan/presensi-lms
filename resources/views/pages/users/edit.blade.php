            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-1">
                            <span data-feather="home" class="feather-sm me-1"></span> Live in <a href="#">{{ $bio->address }}</a>
                        </li>
                        <li class="mb-1">
                            <span data-feather="phone" class="feather-sm me-1"></span> Phone <a href="#">{{ $bio->phone }}</a>
                        </li>
                        <li class="mb-1">
                            <span data-feather="calendar" class="feather-sm me-1"></span> Date of birth <a href="#">{{ $bio->date_of_birth }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                   ...
                   <form action="{{ route('profile.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone" name="phone" value="{{ $bio->phone }}">
                                @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" placeholder="Address" name="address" value="{{ $bio->address }}">
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
